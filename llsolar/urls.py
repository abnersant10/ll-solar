...
from lladmin.views import home, clientes_cadastro, clientes_consulta, clientes_alterar, equipamentos, logout_view
...
urlpatterns = [
    ...
    path('clientes-alterar', clientes_alterar, name='clientes-alterar'),
